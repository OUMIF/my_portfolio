    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/OUMIF" target="_blank" rel="noopener noreferrer">
            <i className="ri-github-fill ri-2x"></i>
          </a>
          
          <a href="https://www.linkedin.com/in/el-mehdi-el-adnani-a4566425a/" target="_blank" rel="noopener noreferrer">
            <i className="ri-linkedin-box-fill ri-2x"></i>
          </a>
          
          <a href="https://leetcode.com/u/oumif/" target="_blank" rel="noopener noreferrer">
            <i className="ri-code-box-fill ri-2x"></i>
          </a>
        </div>
